const I18N = {
    en: {
        ...
        "timeline.1.title": "The 28th China Robot and Artificial Intelligence Competition (CRAIC)",
        ...
        "timeline.4.title": "The 28th China Robot and Artificial Intelligence Competition (CRAIC) — National Finals",
        "timeline.4.desc": "Contributed to robot algorithm and neural network design, winning the National Second Prize.",
        "timeline.5.title": "2026 Contemporary Undergraduate Mathematical Contest in Modeling (CUMCM)",
        "timeline.5.desc": "Served as the modeler and also contributed as the programmer.",
        "selected.title": "Selected Projects",
        "selected.1.title": "MineSymphony",
    ...
    zh: {
        ...
        "stack.title": "技术栈",
        "timeline.title": "时间线",
        "timeline.1.title": "第28届中国机器人及人工智能大赛（CRAIC）",
        ...
        "timeline.4.title": "第28届中国机器人及人工智能大赛（CRAIC）全国总决赛",
        "timeline.4.desc": "参与机器人算法与神经网络设计，获全国二等奖。",
        "timeline.5.title": "2026年高教社杯全国大学生数学建模竞赛（CUMCM）",
        "timeline.5.desc": "担任建模手并兼任代码手。",
        "selected.title": "精选项目",
        "selected.1.title": "MineSymphony",
